...
begin
 if radiobutton1.checked=true then   //se è scelta l'opzione: CODIFICA
  Button1.click  //esegui l'operzione del button1
 else            //altrimenti
  if radiobutton5.checked=true then //se è scelta l'opzione DECODIFICA
   if radiobutton2.Checked=true then //se è scelta anche l'opzione: SAPENDO LA CHIAVE
 ...
 if radiobutton6.checked=true then
  ...
  for a:=0 to c do
   begin
    ...
    closefile(b);
    label5.Caption:='Ok, il codice è stato decodificato!!!';
